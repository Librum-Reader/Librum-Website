    ...
    >
      <Flex w={{ base: "100%", md: "80%" }} direction="column">
        ...
        <Flex direction="column" gap="1rem">
          <Text>
            We are constantly working on new features or on improving old ones.
          </Text>
          <Text>
            ...
            open-source community and help us shape the future of Librum's user
            interface.
          </Text>
          <Text>
          ...
          <Text>
            If you are interested in contributing to Librum's design, feel free
