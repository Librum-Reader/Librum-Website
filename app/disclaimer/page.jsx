...
const Disclaimer = (props) => {
  return (
    <VStack mt={8} mb={8} ml={24} mr={24} spacing={4} align="flex-start">
      ...
      <Heading size="md">Purpose of Librum</Heading>
      <Text>
      ...
      <Heading size="md">Copyrighted Materials</Heading>
      <Text>
      ...
      <Heading size="md">Changes to Disclaimer</Heading>
      <Text>
      ...
      <Heading size="md">Legal Advice</Heading>
      <Text>
