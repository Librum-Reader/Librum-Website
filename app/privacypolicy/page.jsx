...
const PrivacyPolicy = (props) => {
  return (
    ...
    >
      ...
      <Text textColor="legal-text">Service refers to the Application.</Text>
      <Text textColor="legal-text">
      ...
      <Heading fontSize="1em" textColor="legal-text">
        Personal Data
      </Heading>
      <Text textColor="legal-text">
      ...
      <UnorderedList styleType="lower-alpha" mb="3.2em" textColor="legal-text">
