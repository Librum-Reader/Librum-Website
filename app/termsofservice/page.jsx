			...
			<OrderedList spacing={4}>
				...
				<ListItem fontSize="2xl">
					...
					<OrderedList mt={4} spacing={2} fontSize="xl">
						...
						<ListItem>
							You will be asked to give your express agreement to these terms
							and conditions before you use and access our website and
							application.
						</ListItem>
						<ListItem>
							This document does not affect any statutory rights you may have as
							a consumer or a user.
						</ListItem>
						<ListItem>
							We may change these terms and conditions at any time without
							notice. Your continued use of our website and the application
