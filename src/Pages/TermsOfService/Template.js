const Template = () => (
  <div className="main-template">
    ...
    <h2>7. Warranties and representations</h2>
    ...
    <h2>16. Statutory and regulatory disclosures</h2>
